    ...
    return {
      ...
      listConf: {
        ...
        columns: [
          ...
          {title: '头像', align: 'center', key: 'avatar',
            width: 80,
            render: (h, params) => {
          ...
          {title: '性别', align: 'center', width: 120, key: 'sex_name', render:(h, params)=>{
          ...
          {title: '可提现收益', align: 'center', width: 100, key: 'money', render:(h, params)=>{
          ...
          {title: '是否导师', align: 'center', width: 100, key: 'status', render: (h, params) => {
            return h('div', [
              h('i-switch', {
                props: {
