<template lang="html">
  <div class="sound-comments-index">
    <myTable ref="listTable" :listConf="listConf" @select="selectRow" @searchReset="searchReset" :noSearch="false">
    ...
    statusOper: function () {
      ...
      _this.$refs['statusForm'].validate((valid) => {
        if (valid) {
          ...
          Util.ajax({
            url: '/adminapi/soundComments/'+ _this.statusForm.id +'/statusOper',
            method: 'patch',
